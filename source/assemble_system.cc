...
void TopographySolver<dim>::assemble_system(const bool initial_step)
{
    ...
    WorkStream::run(dof_handler.begin_active(),
                    ...
                    std::bind(&TopographySolver<dim>::copy_local_to_global_matrix,
                              ...
                              std::placeholders::_1,
                              initial_step),
                    Assembly::Scratch::MatrixData<dim>(fe_system,
                                                       quadrature_formula,
                                                       face_quadrature,
                                                       update_values|
                                                       update_gradients|
                                                       ...
                                                       update_JxW_values),
                    Assembly::Copy::MatrixData<dim>(fe_system));
}
...
void TopographySolver<dim>::assemble_rhs(const bool initial_step)
{
    ...
    WorkStream::run(dof_handler.begin_active(),
                    ...
                    std::bind(&TopographySolver<dim>::copy_local_to_global_rhs,
                              ...
                              std::placeholders::_1,
                              initial_step),
                    Assembly::Scratch::RightHandSideData<dim>(fe_system,
                                                              quadrature_formula,
                                                              face_quadrature,
                                                              update_values|
                                                              update_gradients|
                                                              ...
                                                              update_normal_vectors|
                                                              update_JxW_values),
                    Assembly::Copy::RightHandSideData<dim>(fe_system));
}
