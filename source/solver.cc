...
// model parameters
rotation_vector(Point<3>::unit_vector(1)),
gravity_vector(-Point<3>::unit_vector(1)),
background_density_gradient(-Point<3>::unit_vector(1)),
background_velocity_value(Point<3>::unit_vector(0)),
background_velocity_gradient(),
background_field_value(Point<3>::unit_vector(1)),
